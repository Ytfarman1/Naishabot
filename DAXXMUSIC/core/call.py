...
# Extra ffmpeg flags to reduce lag / improve reconnects on remote URLs
FFMPEG_RECONNECT_FLAGS = (
    "-reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 5 "
    "-rw_timeout 15000000 -max_muxing_queue_size 9999 -bufsize 2M"
)
    ...
    async def skip_stream(
        ...
        if video:
            stream = AudioVideoPiped(
                ...
                audio_parameters=HighQualityAudio(),
                video_parameters=MediumQualityVideo(),
                additional_ffmpeg_parameters=FFMPEG_RECONNECT_FLAGS,
            )
        else:
            stream = AudioPiped(
                link,
